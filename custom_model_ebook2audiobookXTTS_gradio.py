...
def convert_ebook_to_audio(ebook_file, target_voice_file, language, use_custom_model, custom_model_file, custom_config_file, custom_vocab_file):
...
inputs = [
    ...
    gr.File(label="Custom Vocab File (Optional)")
]
output = gr.Textbox()
